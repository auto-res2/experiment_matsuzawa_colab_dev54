...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{ images/pareto\_curve.pdf }
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{ images/ablation\_fid.pdf }
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{ images/budget\_accuracy.pdf }
